...
def studios(request):
    ranges = {'range_s1': range(2, 6),
              ...
              'range_s9': range(2, 9),
              'range_s10': range(2, 5)}
    return render(request, 'generic/studios.html', ranges)
...
def apartments(request):
    ...
    return render(request, 'generic/apartments.html', ranges)


def surroundings(request):
    return render(request, 'generic/surroundings.html')
...
def guestbook(request):
    ...
    return render(request, 'generic/guestbook.html', context)


def gallery(request):
    return render(request, 'generic/gallery.html')


def prices_and_faqs(request):
    return render(request, 'generic/prices_and_faqs.html')
...
def contact(request):
    ...
    if request.method == 'POST':
        if 'Submit-Contact' in request.POST:
            ...
            return render(request, 'generic/contact.html', {'message': message})
